    ...
    <div style={{ padding: "40px" }}>
      ...
      {data?.overdueCount > 0 && (
        <div style={{
          ...
          padding: "12px 16px", marginTop: "16px", fontSize: "13px", color: "#b91c1c",
        }}>
          <AlertTriangle size={15} />
          支払期限を過ぎた請求書が <strong style={{ margin: "0 4px" }}>{data.overdueCount}件</strong> あります。至急ご確認ください。
          <Link href="/client/invoices?filter=overdue"
            style={{ marginLeft: "auto", fontSize: "12px", color: "#b91c1c", textDecoration: "underline" }}>
            確認する →
          </Link>
        </div>
      )}
